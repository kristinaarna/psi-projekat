...
Да бисмо нешто корисно урадили са референцом на коцку, требало би да се јачувамо у неку променљиву. Креирање нове променљиве врши се позивом функције `var`. У следећем примеру дохватићемо коцку која је директно испред нас (координате (0, 0, -1)) и сачуваћемо је у променљиву `block`
